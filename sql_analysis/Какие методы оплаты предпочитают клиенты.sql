-- Бизнес-кейсы
-- 3.Какие методы оплаты предпочитают клиенты?
-- 3.1 Какие платежные методы используют чаще всего?
...
-- 3.2 Есть ли разница в среднем чеке в зависимости от способа оплаты?
