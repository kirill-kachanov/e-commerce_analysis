...
-- 1.1 Какое среднее время от заказа до доставки в разрезе месяцев?
...
-- 1.2 Найти среднюю и медианную величину задержки товара в разрезе категорий, количество задержек, 
-- процент задержек, а также отличие медианы категории от общей медианы.
